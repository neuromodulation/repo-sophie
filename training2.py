...
#läuft durch auf cuda

device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
print(f"trains on {device}") #####################


#training without initialized weights etc., didnt test it yet
#TODO: override memberfunktion load_dataset to preprocess BIDS data in the best case?
#Architecture: maybe BrainBERT inspired? (also based on wav2vec2) 
#where do u differentiate between unlabeled and labeled data in the code?
...
def main():
    ...
    training_args = TrainingArguments(
        output_dir="./wav2vec2-without-pretraining-demo",
