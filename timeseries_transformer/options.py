...
class Options(object):
    ...
    def __init__(self):
        ...
        # I/O
        self.parser.add_argument('--output_dir', default='./output_Transformer',
        ...
        self.parser.add_argument('--no_timestamp', action='store_true', default=False,
        ...
        self.parser.add_argument('--data_class', type=str, default='bids',
        ...
        self.parser.add_argument('--masking_ratio', type=float, default=0.10, #0.15
